var questions = [
    ...
    var onComplete = function() {
        ...
        fetch('/individual_registration', {
            ...
            body: JSON.stringify({
                ...
                username: questions[3].answer,
                password: questions[4].answer
            })
        })
        ...
        .then((res) => {
            if(!res.success){
                ...
                setTimeout(() => {
                    window.location.href = '/individual_registration';
                }, 4000);
            } else {
                ...
                setTimeout(() => window.location.href = '/individual', 4000);
            }
        })
    ...
    ;(function(questions, onComplete) {
        ...
        first_password = "hi"
        first_password_position = 4
        second_password_position = 5
