var questions = [
    ...
    var onComplete = function() {
        ...
        .then((res) => {
            if(!res.success){
                ...
                setTimeout(() => {
                    window.location.href = '/management_registration';
                }, 4000);
            } else {
                ...
                setTimeout(() => window.location.href = '/management', 4000);
            }
        })
    ...
    ;(function(questions, onComplete) {
        ...
        first_password = "hi"
        first_password_position = 3
        second_password_position = 4
