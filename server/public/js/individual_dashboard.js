$(document).ready( function() {
  ...
  $('body').on("click", "nav ul li a", function(){
   ...
   fetch('/individual/details').then((result) => result.json()).then((res) => {
    // console.log(res);
    if(res.success){
...
//   fetch('/individual/schedules/all').then((result) => result.json()).then((res) => {
//     console.log(res);
...
//    fetch('/individual/schedules/preferred').then((result) => result.json()).then((res) => {
//     console.log(res);
...
function fetch_posts() {
	fetch('individual/timeline/all').then((result) => result.json()).then((res) => {
	  //console.log(res);
	  for(let key in res){
		let p = document.createElement('div');

		p.innerHTML = "Description:"+res[key]["description"]+"</br>";
...
// {
//   fetch('/individual/schedule/deopt',{
//     method : "POST",
//     body: JSON.stringify(
//     {
//       name : sname,
